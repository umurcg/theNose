...
public class City2GameController : MonoBehaviour {
    public GameObject Horse, Player, Nose, CSub, NSub, Obstacles, noseEnterTrigger, HorseAimOne, SubHolder, NarCS, newspaper, Girlgame, LightObj, HorseAimTwo;
    ...
    public IEnumerator<float> _noseEnter()
    {
        ...
        Pacing pac = Player.GetComponent<Pacing>();
        pac.enabled = true;
