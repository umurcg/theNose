...
//This script apply importer settings for characters. folder is main path of buildings and fileExtension is extension of building files.

public class CharacterImporter : AssetPostprocessor
{

    static string folder = "Assets/Models(blend)/Karakterler/";
