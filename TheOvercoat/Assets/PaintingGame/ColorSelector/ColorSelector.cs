...
public class ColorSelector : MonoBehaviour {
	...
	void Start () {
        ...
        testCube = Instantiate(GameObject.CreatePrimitive(PrimitiveType.Cube));
        testCube.name = "Cubeeeeee";

        refCamera = CharGameController.getCamera().GetComponent<Camera>() ;
	...
	void UserInputUpdate(){
        ...
        //testCube.transform.position = cursorPos;

        

        Ray cursorRay = refCamera.ScreenPointToRay(cursorPos);
        //Ray cursorRay = new Ray(refCamera.transform.position, Input.mousePosition);
